...
| 项目 | 实际值 |
|---|---|
| 基线提交 | `0d59e73f5382f404dbd557d3b9d87156bab5638a` |
| 工作区状态 | `dirty`，仅包含 MC-620 的采集代码、原始结果和台账更新 |
| 构建类型 | Release |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Classic | 1,149,584 ns | 2,014,910 ns | 2,065,132 ns | 100.106 条/秒 | 0 | 0 | 0 | 0 | 9,989,400,918 ns |
| Choreography | 1,209,867 ns | 2,021,501 ns | 2,166,072 ns | 100.109 条/秒 | 0 | 0 | 0 | 0 | 9,989,094,811 ns |
